...
class FilterViewController: UIViewController {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            // Price Label
            priceLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 40),
            ...
            priceValueLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -24),
            
            // Price Slider
            priceSlider.topAnchor.constraint(equalTo: priceLabel.bottomAnchor, constant: 20),
            priceSlider.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24),
            priceSlider.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -24),
            
            // Rating Label
            ratingLabel.topAnchor.constraint(equalTo: priceSlider.bottomAnchor, constant: 40),
            ratingLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24),
            
            // Rating Stack
            ratingStackView.topAnchor.constraint(equalTo: ratingLabel.bottomAnchor, constant: 16),
            ratingStackView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24),
            ratingStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -24),
            
            // Sort Label
            sortLabel.topAnchor.constraint(equalTo: ratingStackView.bottomAnchor, constant: 40),
            sortLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24),
            
            // Sort Stack
            sortStackView.topAnchor.constraint(equalTo: sortLabel.bottomAnchor, constant: 16),
            sortStackView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24),
            sortStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -24),
            sortStackView.bottomAnchor.constraint(lessThanOrEqualTo: resetButton.topAnchor, constant: -20),
